...
IoU - это метрика, которая оценивает качество совпадения предсказанного и эталонного bbox. Она вычисляется как отношение площади пересечения к площади объединения этих двух bbox:
