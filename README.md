...
* Мы выкладываем пример данных из приватного датасета по HTR ([ссылка](https://dsworks.s3pd01.sbercloud.ru/aij2021/sample_data/sample_private.zip)). В данном примере 200 сэмплов, половина - на английском, половина - ну русском. В приватной части датасета перевернутых изображений не будет.
